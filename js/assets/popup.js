$(document).ready(function() {
	...
	$('.mobile-contact-btn').click(function() {
		var closeModal = $("<a style='position:absolute;right:10px;top:10px;' href='javascript:;'><img class='close-modal close-modal-js' src='images/listings/x-icon.jpg' style='height:20px;width:20px;'></a>");
