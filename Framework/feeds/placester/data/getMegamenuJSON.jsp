...
<%if (requestID == null || requestID.isEmpty()) { %>
	...
	<bdc:getFolderObjects var="folderResult2" path="/Boston/Production/BDC/WebPages/real-estate/placester" filterType="dwp_placester_homepage" />
...
<% if (requestMode.equals("full")) { %>
		<bdc:getPlacesterElement loid="${item.loid}" var="itemOutput" filterZone="menu_panel"/>
