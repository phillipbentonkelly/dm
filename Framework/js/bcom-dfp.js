// classic bcom-dfp.js. Do not change, touch, or look too closely at
...
(function( bcom ){
    ...
    bcom.dfp.adCatalog = [
        ...
        },
        {
            name: 'ad_headline1',
            size: [[234, 60]],
            position: ['atf', 'headline1']
        },
        {
            name: 'ad_headline2',
            size: [[234, 60]],
            position: ['btf', 'headline2']
        },
        {
            name: 'ad_header',
            size: [[539, 30]],
        ...
        {
            name: 'ad_featuredadvertiser',
            size: [[187, 980]],
            position: 'featuredadvertiser'
        },
        {
            name: 'ad_bigbox',
            size: [[300, 250]],
        ...
        {
            name: 'ad_showcasebanner',
            size: [[329, 75]],
            position: 'ad_showcasebanner'
        }
    ];
    ...
    */
    ...
    function addAAMValuesToKeyValuePairs(){
      bcom.dfp.keyValuePairs.aam_dfp  = getCookie("aam_dfp");
      bcom.dfp.keyValuePairs.aam_uuid = getCookie("aam_uuid");
    }
