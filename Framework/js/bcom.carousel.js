...
/*
 * Content Carousel module for Boston.com
 * by Pete Karl (@steyblind) with edits by Jesse Marple
*/
bcom.carousel = (function() {
	'use strict';
		...
		if(typeof Swiper !== 'undefined') {
			...
			var leadSwiper = new Swiper('.swiper-mod', {
                ...
                noSwiping: function(){
                    ...
                    //TODO: for the moment this is only tageting browsers with a viewport smaller than 786px. We need to introduce some logic RE html.touch etc.
                    // something like $('html').hasClass('touch')
                    if ($(window).width() < 768 ){
                        return true;
                    } else {
                        return false;
