...
<meta name="WT.si_x" content="1" />
  ...
  <div id="container">
    ...
    <div id="header">
        <div class="member-header">
          ...
          <div class="member-header-inner">
            ...
            <h1>
	            <img src="https://graphics.boston.com/universal/regi/images/member_center_icon.png">
	            <img src="https://graphics.boston.com/universal/regi/images/member_center_text.png">
            </h1>
      ...
      <div id="content" class="section section95">
        ...
        <div id="Col1">
          <div class="login-success">
            ...
            <br> 
            Click here to return to the Boston.com home page. 
            <br>
	...
	s.pageName='Member Center | BCom Registration | Thanks for updating your profile',s.channel='Member Center',s.prop1='Member Center | BCom Registration';
