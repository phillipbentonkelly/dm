...
<% if (requestFormat.equals("json")) { %>
	<jp:include url="/SysConfig/WebPortal/BDC/Framework/feeds/placester/data/getCategoryPagesJSON.jsp?mode=${requestMode}&id=${requestID}&JSONCallback=${JSONCallback}"/>
<%}%>