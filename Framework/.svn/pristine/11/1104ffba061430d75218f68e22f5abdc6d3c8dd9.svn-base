var pushdownOptions = {
   static_fallback: 'http://cache.boston.com/images/ads/citizens/tester/pushover_fallback.gif',
   flashAutoPlay: 'http://cache.boston.com/images/ads/citizens/tester/citizens_740x580_pushover_010414.swf',
   flashReplay: 'http://cache.boston.com/images/ads/citizens/tester/citizens_740x580_pushover_010414_replay.swf',
   width: 959,
   height: 650,
   closeAmount: 0,
   clickTags: {
...
;(function(o){
   ...
   var Pushdown = exports.Pushdown = function(){
      ...
      var autoplay = hasCookie('Pushover_' + o.cookie_name, 'seenPushover', true);
      ...
      // know what you'd like to replace with flash
      // this is an ID
      var replaceID = 'pushover-replace';
      ...
      function appendStatic(){
         ...
         console.log('Pushover creative: \n%s', (autoplay ? o.flashAutoPlay: o.flashReplay));
         addFlash();
      }
      ...
      function addFlash(){
         controller.replaceWithFlash({
            ...
            url: (!autoplay ? o.flashAutoPlay: o.flashReplay),
            replaceID: replaceID,
            width: o.width,
            height: o.height,
            callback: function(res){
               console.log('results from pushover:', res);
               if(res.success){
                  creativeType = 'flash';
               }
               return;
      ...
      function openSite(){
         // replay the creative by showing/hiding 
         // the div.
         // this is a shortcut and could probably be improved
         $('#' + replaceID)
            .hide()
            .show();
   ...
   controller.setOpen('moveSite');
   controller.setClose('closeSite');

   controller.addCreative('fwd', pushdown, pushdown);
   // controller.addCreative('pwd-tall', pushdown, pushdown);
   // controller.addCreative('pwd-wide', pushdown, pushdown);
