...
<%
	...
	pageContext.setAttribute("siteRoot", sr);
%>
...
<%
	String validSectionTest = (String) pageContext.getAttribute("testForValidSection");
	String appendSiteRoot = (String) pageContext.getAttribute("siteRoot");
	...
	pageContext.setAttribute("finalFolderPath", finalFolderPath);
%>
...
<%
	//String xvalueFull = (String) pageContext.getAttribute("//props/PortalSiteConfig/SectionPage");
	String finalFolderPathFull = new String("/SysConfig/WebPortal/sites/BDC/news");
	String sectionFullPath = new String("/news");
	String zoneNameArg = (String) pageContext.getAttribute("zoneName");
	...
	pageContext.setAttribute("dwpPathReturn",dwpPath);
%>
