...
<body>
  ...
  <div id="container">
    <div id="containerBorder">
      ...
      <div id="content">
        <div id="Col1">
          ...
          <div class="create-password-email-sent">
          	<h3>
              Please check your e-mail now for a message from Boston.com with the subject line "Boston.com Account Request." 
							<br>
							Click the link in the e-mail to choose a new password for your Boston.com membership.
            </h3>
					</div>
        ...
        <div id="Col2" class="half-page-split">
	...
	s.pageName='Member Center | BCom Registration | BCom Forgot password step 2 - Check your e-mail',s.channel='Member Center',s.prop1='Member Center | BCom Registration';
