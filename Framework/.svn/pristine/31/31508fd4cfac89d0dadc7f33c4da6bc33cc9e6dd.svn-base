/* port from old context. do not modify */
    ...
    createUserAction: function() {
        ...
        if(this.thumbType === 'image'){
			...
			//we should really set a default image to use in the instance that we don't have an image set for an article
	                type: 'image',
	                src: this.thumbnail,
	                href: 'http://c.o0bc.com/rw/SysConfig/WebPortal/Boston/Framework/images/site_graphics/icons/share/bcom_og_news.gif'
	        }
		...
		if(this.thumbType === 'video'){
			var video = {
                ...
                previewImageURL: 'http://c.o0bc.com/rw/SysConfig/WebPortal/Boston/Framework/images/site_graphics/icons/share/bcom_og_news.gif',
                type: 'flash'
            }
