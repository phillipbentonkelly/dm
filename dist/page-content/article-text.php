<div class="articles-content__article">
    <div class="row articles-content__article__author-link-row">
        <div class="col articles-content__article__by-line">
            <img class="author" src="images/authors/julie-xie.jpg" />
            <h1>Julie Xie</h1>
            <p>Boston.com staff</p>

            <a href="https://twitter.com/juliexie" class="social-wrapper__twitter" target="_blank">
        ...
        <div class="colRight articles-content__article__links">
            <ul>
                <li><a href="javascript:;">About this Neighborhood</a></li>
                <li><a href="javascript:;">View Listing</a></li>
                <li><a href="javascript:;">Contact Agent</a></li>
                <li><a href="javascript:;">More Listings in this Area</a></li>
            </ul>
        </div>
    </div>
    ...
    <p>This 1.32-acre, 10,279-square foot beachfront property in Cape Cod has been on the
    market for about three years but couldn’t entice a buyer (maybe because of its $13.9
