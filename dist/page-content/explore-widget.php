<div class="explore-widget__container"> 
    <h1 class="explore-widget__header">Explore</h1>
    <div class='explore-widget__img-wrapper'>
        <img src='images/neighborhoods/top-neighborhoods__entry__2.jpg'>
        <h1 class="explore-widget__img-overlay">Brookline
        </h1>
    </div>
