...
<div class="saved-listings">
    ...
    <div class="search-results__filter-bar">
        ...
        <select class="sort-drop">
            ...
            <option value="total_images" selected="selected">Total Images</option>
			<option value="location.address">Address</option>
			<option value="location.locality">City</option>
			<option value="location.region">State</option>
			<option value="location.postal">Zip</option>
			<option value="cur_data.beds">Beds</option>
			<option value="cur_data.baths">Baths</option>
			<option value="cur_data.price">Price</option>
			<option value="cur_data.sqft">Square Feet</option>
        </select>
    ...
    <div id="result1" class="saved-listings__item">
        ...
        <div class="header serp-item-hovered">
            <a href="javascript:;"><p class="address">101 Fernwood Road, Brookline, Ma</p></a>
        </div>
        ...
        <div class="right-col">
            <div class="property-info">
                ...
                <div class="row2">
                    <p class="sqfeet">10,000 Sq. Ft.</p>
                    <p class="beds">5 Beds</p>
                </div>

                <div class="row3">
                    <p class="baths">6 Baths</p>
                    <p class="partials">3 Partial</p>
                </div>
    ...
    <!-- SEARCH RESULT ITEM -->
    <div id="result2" class="saved-listings__item">
    ...
    <div class="saved-listings__filter-bar-bottom">
