...
<div class="gallery-widget">
    <div class="gallery-widget__main-wrapper">
    	<div class="gallery-widget__main-wrapper__scrolling-wrapper">
			<a href="javascript:;" data-direction="prev" class="gallery-widget__main-wrapper__nav-arrows chevron left js-slider-previous disable" title="Previous" alt="Previous"></a>
    		<a href="javascript:;" data-direction="next" class="gallery-widget__main-wrapper__nav-arrows chevron right js-slider-next" title="Next" alt="Next"></a>

	    	<div class="gallery-widget__main-wrapper__scrolling-wrapper__scroller">
				<div class="slide">
	    ...
	    <div class="gallery-widget__details">
	    	<div class="gallery-widget__details__info-nav">
	    		...
	    		<div class="gallery-widget__details__info-nav__counter">
	    			<span class="gallery-widget__details__info-nav__counter__current">1</span> of <span class="gallery-widget__details__info-nav__counter__total">5</span>
	    		</div>
	    	</div>
	    	<div class="gallery-widget__details__caption">
				...
				on the market for about three years but couldn't entice a buyer (maybe because of its $13.9
				million price tag).</p>
				<p class="gallery-widget__details__caption__photo-credit">Photo Credit- Elyssa Cohen</p>
	    	</div>
	    </div>
